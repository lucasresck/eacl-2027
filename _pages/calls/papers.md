...
<h1>EACL 2027 Call for Papers</h1>
...
## Two Stage Review: Submission to ARR, Commitment to EACL
...
EACL 2027 has chosen this approach in coordination with *CL 2027 conferences, which are adopting the same procedure and a coordinated submission plan to allow maximum flexibility during their submission periods for the authors. At each cycle, after a paper has been fully reviewed, authors have the option to commit their paper to a conference, or revise and resubmit for another round of reviews.
